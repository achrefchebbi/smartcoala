...
import com.example.smartcoala1.LottieDialogFragment;
...
public class RegistrationActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp = MediaPlayer.create(RegistrationActivity2.this, R.raw.buttonsound);
        ...
        firebaseAuth.createUserWithEmailAndPassword(inputEmail,inputPw).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    DynamicToast.makeError(RegistrationActivity2.this, task.getException().getMessage(), 10).show();
                    startActivity(new Intent(RegistrationActivity2.this, RegistrationActivity2.class));
                    finish();
                }}
        });
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            DynamicToast.makeSuccess(RegistrationActivity2.this, "Check Email For Verification.", 10).show();
                            startActivity(new Intent(RegistrationActivity2.this, LoginActivity2.class));
                            finish();
                        }
                        else
                        {
                            FirebaseAuth.getInstance().signOut();
                            DynamicToast.makeError(RegistrationActivity2.this, "Unable to Send Mail", 10).show();
                            startActivity(new Intent(RegistrationActivity2.this, RegistrationActivity2.class));
                            finish();
                        }
                    }
